...
class OrderPricingWorkflowTest extends TestCase
{
    ...
    public function test_member_can_repeat_a_previous_order_item_image_and_keep_private_files(): void
    {
        ...
        $previousItem = OrderItem::query()->create([
            ...
            'customer_design_path' => 'customer-designs/design.png',
            'customer_design_paths' => ['customer-designs/design.png'],
            'unit_price' => 1.2,
            'line_total' => 120,
        ]);
        ...
        $this->assertSame($previousItem->customer_design_paths, $newItem->customer_design_paths);
