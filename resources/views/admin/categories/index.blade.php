...
<div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
    ...
    <div class="flex items-center gap-3">
        <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center justify-center gap-3 rounded-2xl bg-brand-600 px-8 py-4 text-sm font-black text-white shadow-xl shadow-brand-100 hover:bg-brand-500 transition-all active:scale-95 group/btn">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="relative whitespace-nowrap py-8 pl-4 pr-10 text-right text-sm font-medium">
                            <div class="flex justify-end items-center gap-3 transform group-hover:-translate-x-2 transition-transform duration-300">
                                <a href="{{ route('admin.categories.edit', $category) }}" class="inline-flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-xs font-black text-slate-700 shadow-sm ring-1 ring-slate-200 hover:bg-slate-50 hover:ring-brand-300 transition-all uppercase tracking-widest">
