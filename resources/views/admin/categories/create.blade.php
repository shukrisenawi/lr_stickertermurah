    ...
    <div class="bg-white rounded-3xl shadow-sm ring-1 ring-slate-200 overflow-hidden">
        <form method="post" action="{{ route('admin.categories.store') }}" class="p-8 space-y-6">
            ...
            <div class="pt-4 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="inline-flex items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-8 py-3.5 text-sm font-black text-white shadow-lg shadow-indigo-100 hover:bg-indigo-500 transition-all border-b-4 border-indigo-800 active:border-b-0 active:translate-y-1">
                    Simpan Kategori
                </button>
            </div>
        </form>
