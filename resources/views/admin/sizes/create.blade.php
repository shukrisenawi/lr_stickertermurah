        ...
        <form method="post" action="{{ route('admin.sizes.store') }}" class="p-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="md:col-span-2">
                    <label class="block text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2 pl-1">Nama Pilihan (cth: Saiz A4 / Custom)</label>
                    <input type="text" name="name" class="block w-full rounded-2xl border-0 py-3.5 px-4 text-slate-900 font-bold tracking-wider ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-brand-600 shadow-sm" placeholder="Masukkan nama label saiz..." required autofocus>
                </div>

                <div>
                    <label class="block text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2 pl-1">Lebar (cm)</label>
                    <div class="relative">
                        <input type="number" step="0.01" name="width_cm" class="block w-full rounded-2xl border-0 py-3.5 pl-4 pr-12 text-slate-900 font-bold tracking-wider ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-brand-600 shadow-sm" placeholder="0.00">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" step="0.01" name="height_cm" class="block w-full rounded-2xl border-0 py-3.5 pl-4 pr-12 text-slate-900 font-bold tracking-wider ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-brand-600 shadow-sm" placeholder="0.00">
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4">
                            <span class="text-xs font-black text-slate-300">CM</span>
                        </div>
                    </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="price" class="block w-full rounded-2xl border-0 py-3.5 pl-16 pr-4 text-brand-600 font-black tracking-wider ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-brand-600 shadow-sm" placeholder="0.00" required>
                    </div>
                </div>
            </div>
