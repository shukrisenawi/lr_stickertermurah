            ...
            <aside className="space-y-6">
              ...
              <section className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                ...
                <div className="mt-5 grid grid-cols-1 gap-3">
                  <Link href={route('member.orders.create')} className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-brand-600/20 transition hover:bg-brand-700 active:scale-[0.98]">
