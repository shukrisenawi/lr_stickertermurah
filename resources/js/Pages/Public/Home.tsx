                    ...
                    <div className="relative mt-12 grid grid-cols-2 gap-5 md:grid-cols-4">
                        ...
                        {[
                            ...
                            },
                            {
                                icon: Truck,
                                title: 'Bayar Invoice',
                                copy: 'Anda boleh lihat invoice dan bayar di laman ahli.',
                            },
                        ].map((step, i) => (
                            <Reveal key={step.title} delay={i * 120}>
                                <div className="relative flex h-full flex-col items-center rounded-3xl border border-slate-100 bg-white px-3 py-5 text-center shadow-sm md:px-6 md:py-8">
