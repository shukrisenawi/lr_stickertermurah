...
interface DesignSelectionProps extends PageProps {
  categories: Array<{
    id: number;
    name: string;
    prefix: string | null;
...
export default function DesignSelection() {
  const { app, categories, allDesigns } = usePage<DesignSelectionProps>().props;
  ...
  return (
    <>
      <Head title="Pilih Design Sticker - StickerTermurah" />
      ...
      <div className="min-h-full bg-white text-slate-900 antialiased">
          ...
          <div className="mx-auto flex h-[72px] max-w-[1280px] items-center justify-between px-4 lg:px-8">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-brand-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-brand-700 shadow-lg shadow-brand-600/20"
              >
        ...
        {/* ========== HERO ========== */}
        <section className="bg-gradient-to-b from-brand-50/50 to-white pt-12 pb-8 lg:pt-16 lg:pb-12">
          <div className="mx-auto max-w-[1280px] px-4 text-center lg:px-8">
            ...
            <p className="mt-3 text-base text-slate-500 lg:text-lg max-w-lg mx-auto">
              Klik pada design untuk mula tempahan. Lebih 30 design premium sedia untuk dipilih!
            </p>
          </div>
        </section>
