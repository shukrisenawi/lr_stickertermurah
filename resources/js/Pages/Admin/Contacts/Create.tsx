...
export default function CreateContact({ connection, customers }: CreateContactProps) {
      ...
      <div className="space-y-6">
        <div className="admin-page-head">
          <div>
            ...
            <h2 className="text-2xl font-bold text-slate-900">Tambah Contact</h2>
            <p className="admin-page-copy">Simpan contact baharu ke akaun Google yang disambungkan.</p>
          </div>
          ...
          <div className="admin-page-actions">
            ...
            <Link href={route('admin.contacts.google.index')} className="admin-btn-secondary">
