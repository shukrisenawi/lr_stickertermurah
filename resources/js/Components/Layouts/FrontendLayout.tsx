          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-slate-400">
                Kami mencetak sticker mirrorcote untuk jenama, produk, perniagaan, majlis perkahwinan, hari jadi dan sebagainya.
              </p>
              <div className="mt-4 flex items-center gap-3">
                {/* Facebook */}
                <a href="https://www.facebook.com/stickertermurahkedah" target="_blank" rel="noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-800 text-slate-400 transition hover:bg-brand-600 hover:text-white">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                {/* Instagram */}
                <a href="https://www.instagram.com/stickertermurah" target="_blank" rel="noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-800 text-slate-400 transition hover:bg-brand-600 hover:text-white">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a href={emailLink} className="transition hover:text-brand-400">{app.admin_email}</a>
                </li>
                <li className="flex items-center gap-2">
                  <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
